...
class TestGitHubTools:
    ...
    def test_github_search_url_defined(self):
        ...
        assert tools_github.GITHUB_SEARCH_URL == "https://api.github.com/search/repositories"
    ...
    def test_search_github_repos_with_valid_query(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.get(tools_github.GITHUB_SEARCH_URL, json=mock_response)

            # Call via invoke since tools are StructuredTool objects
            result = tools_github.search_github_repos.invoke({"query": "top 2 LLM repos"})
    ...
    def test_search_github_repos_no_results(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            result = tools_github.search_github_repos.invoke({"query": "obscure-query-xyz"})
    ...
    def test_search_github_repos_rate_limit_error(self):
        ...
        with requests_mock.Mocker() as m:
            m.get(tools_github.GITHUB_SEARCH_URL, status_code=403, text="API rate limit exceeded")

            result = tools_github.search_github_repos.invoke({"query": "test query"})
    ...
    def test_search_github_repos_http_error(self):
        ...
        with requests_mock.Mocker() as m:
            m.get(tools_github.GITHUB_SEARCH_URL, status_code=500, text="Server error")

            result = tools_github.search_github_repos.invoke({"query": "test query"})

            assert "error" in result.lower() or "error 500" in result
    ...
    def test_search_github_repos_parses_query_count(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            # Test "top 5" parsing
            result = tools_github.search_github_repos.invoke({"query": "top 5 LLM repos"})
    ...
    def test_search_github_repos_default_count(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            result = tools_github.search_github_repos.invoke({"query": "LLM frameworks"})
    ...
    def test_search_github_repos_topic_matching(self):
        ...
        with requests_mock.Mocker() as m:
            m.get(tools_github.GITHUB_SEARCH_URL, json={"total_count": 0, "items": []})

            # Query mentions "rag"
            tools_github.search_github_repos.invoke({"query": "RAG systems"})
    ...
    def test_search_github_repos_language_filter(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            tools_github.search_github_repos.invoke({"query": "Python LLM libraries"})
    ...
    def test_search_github_repos_timeout_handling(self):
        ...
        with requests_mock.Mocker() as m:
            m.get(tools_github.GITHUB_SEARCH_URL, exc=Exception("Connection timeout"))
